...
def main():
    ...
    try:
        with open(log_filename, 'w') as log_file:
            subprocess.run(
                ["python", "D:\\cipher-analyzer\\backend\\StreamBlockTester\\o1_Extract.py", temp_filename, feature_filename],
                check=True,
    ...
    model_filename = "D:\\cipher-analyzer\\backend\\StreamBlockTester\\random_forest_model.pkl"
    try:
    ...
    # Step 8: Filter the features to match those used during training
    ...
    # Step 9: Convert data types to numeric
    features = features.apply(pd.to_numeric, errors='coerce')

    # Step 10: Handle missing values by filling with zeroes
